...
def scoreCross(user: user, performance_seconds: int) -> int:
    ...
    return round(linear_interpolation(performance_seconds, [x_values[index-1], x_values[index]], [y_values[index-1], y_values[index]]))
...
def scoreLongueur(performance_meters: float) -> int:
    ...
    return round(linear_interpolation(performance_meters, [x_values[index-1], x_values[index]], [y_values[index-1], y_values[index]]))
...
def scoreHalteres(performance_kilo: float) -> int:
    ...
    return round(linear_interpolation(performance_kilo, [x_values[index-1], x_values[index]], [y_values[index-1], y_values[index]]))
...
def scoreBalPet(performance_points: int) -> int:
    ...
    return round(linear_interpolation(performance_points, [x_values[index-1], x_values[index]], [y_values[index-1], y_values[index]]))
